...
import com.app.pocketfarm.adapter.MyTeamAdapter
...
//        // Home Activity binding.rlHeader.visibility = View.GONE
        ...
        binding.tvTeamsize.text =  session.getData(com.app.pocketfarm.helper.Constant.TEAM_SIZE)
        binding.tvValidTeam.text =  session.getData(com.app.pocketfarm.helper.Constant.VALID_TEAM)


        binding.tvCopy.text = session.getData(com.app.pocketfarm.helper.Constant.REFER_CODE)
        ...
        binding.btnInvite.setOnClickListener {
            val shareBody = "Hey, I am using WeAgri App. It's a great app to earn money. Use my refer code " + session.getData(
                com.app.pocketfarm.helper.Constant.REFER_CODE) + " to get 100 coins on signup. Download the app from the link below.\n" + ""
    ...
    private fun referlist(level: String) {
        ...
        }, activity, com.app.pocketfarm.helper.Constant.TEAM_LIST, params, true)
