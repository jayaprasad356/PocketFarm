...
class WithdrawalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.llbank.setOnClickListener {
            val intent = Intent(activity, com.app.pocketfarm.activity.UpdatebankActivity::class.java)
    ...
    private fun withdraw() {
        ...
        val params: MutableMap<String, String> = HashMap()
        params["user_id"] = session.getData(com.app.pocketfarm.helper.Constant.USER_ID)
...
//                        finish()
        ...
        }, this, com.app.pocketfarm.helper.Constant.WITHDRAWALS, params, true)
