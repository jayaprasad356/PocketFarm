...
import com.app.pocketfarm.databinding.ActivityInviteBinding
...
class InviteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rlCopy.setOnClickListener {
            ...
            val clip = android.content.ClipData.newPlainText("label", session.getData(com.app.pocketfarm.helper.Constant.REFER_CODE))
